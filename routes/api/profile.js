/* 
    Handles profiles, fetching them, updating, etc
*/
const { check, validationResult } = require('express-validator'); // trying a different way of validation. check users.js for other method
